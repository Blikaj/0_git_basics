...
1. Опишите своими словами значение следующих терминов:
    1. рабочий каталог / ответ - каталог на устройстве, в котором хранятся файлы проекта у пользователя
    2. репозиторий / ответ - в данном случае - хранилище в Git, из которого можно получить доступ к файлам проекта
    3. коммит  / ответ - точка сохранения изменений (или же версия проекта), во время создания которой пользователь указывает изменения в файлах проекта                           относительно предыдущей версии
    4. ветка  / ответ - подгруппа версий/коммитов проекта, созданных в связи с какой-либо нуждой (например основная ветка с                              рабочей версией программы и экспериментальная ветка)
